...
You will need to create an application and API key from the [Dashboard](https://waas.stardust.gg) 
...
In order to use this sdk, you must have an api key. You can obtain this in the dashboard.
